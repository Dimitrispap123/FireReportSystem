 ...
 * @author user
 */
@WebServlet(name = "MessagesAdmin", urlPatterns = {"/MessagesAdmin"})
public class MessagesAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ArrayList<Message> messages = editMessagesTable.getAdminMessages();
